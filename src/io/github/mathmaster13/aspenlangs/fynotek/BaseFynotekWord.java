...
public abstract sealed class BaseFynotekWord permits FynotekWord, OldFynotekWord {
     ...
     */
    public BaseFynotekWord(String word) {
        this(word, null);
    }
     ...
     */
    public BaseFynotekWord(String word, @Nullable Inflection inflection) {
     ...
     * @see #inflection
     */
    protected BaseFynotekWord(String beginning, String vowels, String end, @Nullable Inflection inflection) {
    ...
    protected BaseFynotekWord(String[] word, @Nullable Inflection inflection) {
     ...
     */
    protected BaseFynotekWord(BaseFynotekWord word) {
     ...
     * @see #inflection
     */
    protected abstract String[] _ablaut(Ablaut ablaut);
     ...
     * @see #isMarked()
     */
    public abstract BaseFynotekWord verbTense(Tense tense);
     ...
     * @since 3.0
     */
    public BaseFynotekWord inflect(@Nullable Inflection inflection) {
     ...
     * @see #verbTense(Tense)
     */
    public BaseFynotekWord match(BaseFynotekWord word) {
     ...
     * @see #verbTense(Tense)
     */
    public abstract BaseFynotekWord personSuffix(Person person);
