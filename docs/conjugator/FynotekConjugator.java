...
public class FynotekConjugator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        boolean isFolo = !word.proper && word.toString().equals("folo");
        ...
        String infoString = (word.proper || isFolo ? "Verb Modifier Forms:" : "Verb Tenses:");
...
class FynotekWord {
    ...
    private static final HashMap<Character, Character> caseList = new HashMap<>();
    static {
        caseList.put('a', 'o');
        caseList.put('g', 'i');
        caseList.put('d', 'a');
    ...
    private final static HashMap<Character, Character> tenseList = new HashMap<>();
    static {
        tenseList.put('p', '\u0000');
        tenseList.put('a', 'i');
        tenseList.put('f', 'o');
    ...
    private static final HashMap<Character, Character> hypoTenseList = new HashMap<>(); // hypothetical                                                                      tenses
    static {
    ...
    private FynotekWord ablaut(char vowel) {
        ...
        if (vowel != 'r') { // 'r' is for reduplcation
            if (vowels.charAt(vowels.length() - 1) != vowel) {
                newVowels = (vowels.length() == 1 ? Character.toString(vowel) : (Character.toString(vowels.charAt(0)) + vowel));
            } else {
